...
class InputItemLayout : LinearLayout {
    ...
    @SuppressLint("CustomViewStyleable")
    private fun parseInputStyle(hint: String?, resId: Int, inputType: Int, maxInputLength: Int) {
    ...
    private fun parseTitleStyle(title: String?, resId: Int) {
        ...
        val minWidth = array.getDimensionPixelOffset(R.styleable.titleTextAppearance_minWidths, 0)
